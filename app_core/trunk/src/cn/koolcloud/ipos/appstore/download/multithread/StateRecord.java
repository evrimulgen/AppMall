...
public class StateRecord {
	 ...
	 * @param percent
	 */
	public synchronized void insert(String packageName, int state, int percent){//int state, int percent
	 ...
	 * @param state
	 */
	public synchronized void updateState(String packageName, int state){
	 ...
	 * @param percent
	 */
	public synchronized void updatePercent(String packageName, int percent){
